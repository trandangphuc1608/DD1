...
public class HomeProductAdapter extends RecyclerView.Adapter<HomeProductAdapter.ProductViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ProductViewHolder holder, int position) {
        ...
        holder.tvHomeProductName.setText(product.getName());
        holder.tvHomeProductPrice.setText(formatter.format(product.getPrice()) + " đ");
        ...
        Glide.with(context)
                ...
                .into(holder.ivHomeProductImage);
    ...
    public static class ProductViewHolder extends RecyclerView.ViewHolder {
        ImageView ivHomeProductImage;
        TextView tvHomeProductName, tvHomeProductPrice;
        Button btnAddCart;

        public ProductViewHolder(@NonNull View itemView) {
            super(itemView);
            ivHomeProductImage = itemView.findViewById(R.id.ivHomeProductImage);
            tvHomeProductName = itemView.findViewById(R.id.tvHomeProductName);
            tvHomeProductPrice = itemView.findViewById(R.id.tvHomeProductPrice);
